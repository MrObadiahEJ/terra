...
(128/49/115/169), and CI covers registry/identity lib + rfc012 + geo + API.
...
to match source (128 / 49 / 115 / 169) — re-run `make idl` / `./build.sh`
...
Source counts (regenerate IDL after changes): **128 instructions · 49 account
types · 115 events · 169 `TerraError` codes** in `terra_registry`; **8
...
- [x] Regenerate checked-in IDL from current source (`make idl`) — A2 (2026-09-24): 119/44/108/160; Phase 2 (2026-09-24): 128/49/115/169 synced to `terra-web/src/idl/`
